<?php
	...
	class GoogleProducts_Params extends Core_Configuration_Model {
		...
		protected function build_form() {
            ...
            $this->add_field('refresh_exchange_rates', 'Force refresh exchange rates on feed generation', 'full', db_bool)->tab('General')->renderAs(frm_checkbox)->comment('If a feed is using currency conversion for prices, this will force the exchange rates to be refreshed when the feed is generated.');
